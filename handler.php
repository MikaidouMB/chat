 ...
 */
$db = new PDO('mysql:host=localhost;dbname=chat;charsetutf8', 'mikaidou', 'admin', [
    PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
    PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC
]);

/**
 *  On doit analyser la demande faite via L'URLL (GET) afin de déterminer si on souhaite récupérer les message ou en écrire un
 */
    $task = "list";
...
if($task == "write"){
 ...
 /**
  * Si on vet récupérer, il faut envoyer du JSON 
  */
function getMessages(){
  ...
  /**
   * Si on veut au écrire au contraire, il faut analyser les paramètres envoyés en POST et les sauver dans la base de données
   */
